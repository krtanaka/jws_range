...
(p1 = ggplot() + 
    ...
    scale_fill_gradientn(colors = matlab.like(100),"°C", breaks = c(round(min(r1$layer), 1), 
                                                                    round(mean(r1$layer), 1), 
                                                                    round(max(r1$layer), 1))) +
    scale_color_gradientn(colors = matlab.like(100),"°C", breaks = c(round(min(r1$layer), 1), 
                                                                     round(mean(r1$layer), 1), 
                                                                     round(max(r1$layer), 1))) + 
...
(p1 = r1 %>% 
    ...
    scale_fill_gradientn(colors = matlab.like(100),
                         "°C", breaks = c(round(min(r1$layer), 1), 
                                          round(mean(r1$layer), 1), 
                                          round(max(r1$layer), 1))) +
...
(p2 = r3 %>% 
    ...
    geom_tile(aes(height = 1, width = 1)) +
    scale_fill_gradientn(colors = matlab.like(100),
                         "°C", breaks = c(round(min(r3$layer), 1),
